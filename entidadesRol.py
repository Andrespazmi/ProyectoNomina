...
class Nomina:
    ...
    def mostrarCabeceraNomina(self,razonSocial, direccion, telefono, ruc,tipoRol):
        borrarPantalla()
        print('=========================================================={}========================================================='.format(razonSocial))
        print('Ruc : {} Teléfono : {} Dirección: {}'.format(ruc,telefono,direccion))
        print('='*130)
        print('                            N O M I N A   D E   P A G O  D E   E M P L E A D O S: {}  '.format(tipoRol))
        print('FECHA: {} '.format(self.fecha))
        print('NÓMINA CORRESPONDIENTE AL PERIODO: {}'.format(self.aamm))
        print('='*130) 
